...
function processTrack(p) {
  ...
  if(eventData.size > 0 && eventData.size <= 0.1 ){
    block01();
  } else if (eventData.size > 0.1 && eventData.size <= 0.2){
    block02();
  } else if(eventData.size > 0.2 && eventData.size <= 0.3){
    block03();
  } else if(eventData.size > 0.3 && eventData.size <= 0.4) {
    block04();
  } else if(eventData.size > 0.4 && eventData.size <= 0.5){
    block05();
  } else if(eventData.size > 0.6){
    block06();
  }
